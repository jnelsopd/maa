    ...
    stages {
           ...
           stage('checkout') {
            ...
            dir('/var/lib/jenkins/hello-world') {
             ...
             sh "mv /var/lib/jenkins/hello-worldwebapp/target/*.war /var/lib/jenkins/hello-world/webapp/target/sample.war"
             sh 'scp /var/lib/jenkins/hello-worldwebapp/target/sample.war StrictHostKeyChecking=no root@192.168.1.173:/root/docker1'
